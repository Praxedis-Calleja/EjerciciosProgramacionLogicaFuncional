...
print(tupla[1])#imprime el segundo elemento de la tupla
...
print("¿El primer numero es igual al segundo?:", num1==num2)
print("¿El primer numero es diferente al segundo?:", num1!=num2)
...
aprobado = float(input("Ingresa tu calificacion:"))>=70
