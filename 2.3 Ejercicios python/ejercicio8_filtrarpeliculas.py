...
nueva_lista = list(filter(lambda pelicula: float(pelicula["CalificaciónIMDB"]) > 8.0, lista_peliculas))

calificacion_peliculas = list(map(lambda pelicula: {"titulo": pelicula["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]}, lista_peliculas))
